...
import {
  UserWithRoleRegistrationRequest,
  Role,
  LocationRequest,
        ...
        <div className="bg-gray-900/80 backdrop-blur-sm rounded-xl shadow-lg p-8 border border-gray-800">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={email}
                    disabled
                    className="w-full pl-10 pr-4 py-3 border border-gray-700 rounded-lg bg-gray-800 text-gray-500 cursor-not-allowed"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-700 rounded-lg bg-gray-800 text-gray-100 placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-950 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
